...
extension Film {
    static let samples: [Film] = [
        ...
        Film(
            ...
            description: "In the final months of World War II, 14-year-old Seita and his sister Setsuko are orphaned when their mother is killed during an air raid in Kobe, Japan.",
            releaseDate: "1988",
